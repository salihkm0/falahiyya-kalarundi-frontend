...
export const AttendanceCard = ({ attendance }) => {
  ...
  return (
    <div className="w-auto mx-auto bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl p-8 transform transition-all duration-300 hover:scale-102 hover:shadow-3xl border border-gray-100">
