      ...
      >
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <InputField
              label="Student Name with initials (വിദ്യാർഥിയുടെ പേരും ഇനിഷ്യലും)"
              register={register}
              name="studentName"
            />
            <InputField
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <InputField
              label="Father's Name (പിതാവിന്റെ പേര്)"
              register={register}
              name="fatherName"
            />
            <InputField
              label="Guardian Name & Address (രക്ഷകർത്താവിന്റെ പേര്, വിലാസം)"
              register={register}
              name="guardianName"
            />
            <InputField
            ...
            />
            <InputField
              label="Guardian's Occupation (രക്ഷകർത്താവിന്റെ പ്രവൃത്തി)"
              register={register}
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <br />
            <InputField
              label="Former Madrasa Name (മദ്രസയുടെ പേര്, അംഗീകരണ നമ്പർ)"
              register={register}
              name="formerMadrasa"
              required={false}
            />
