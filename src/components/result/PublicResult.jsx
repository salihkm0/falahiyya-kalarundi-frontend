...
export const PublicResult = ({ result }) => {
  const percentage = (result.mark * 100) / 500;
  return (
    <div className="">
      <div className="w-80 bg-gradient-to-b from-[#16213e] to-[#0f3460] rounded-2xl overflow-hidden border border-[#e94560]/20">
        <div className="relative">
          ...
          <div className="pt-8 pb-4 px-4 text-center">
            {result.image ? (
              ...
              <div
                className={`h-24 w-24 mx-auto rounded-full border-4 border-[#e94560] p-1 mb-3 flex justify-center items-center`}
              >
